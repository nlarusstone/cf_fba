...
if __name__ == '__main__':
    ...
    vae.save('../models/vae_epochs={0}_batch={1}_dimension={2}.h5'.format(n_epochs, batch_size, latent_dim))
    encoder.save('../models/encoder_epochs={0}_batch={1}_dimension={2}.h5'.format(n_epochs, batch_size, latent_dim))
    generator.save('../models/generator_epochs={0}_batch={1}_dimension={2}.h5'.format(n_epochs, batch_size, latent_dim))
